...
export default function EmailButtonModal() {
  ...
  return (
    <>
      <button className="flex items-center justify-center cursor-pointer absolute bottom-72 right-3 w-14 h-14 rounded-full bg-[#00923E] z-10  sm:right-9 sm:bottom-52 md:bottom-40 md:right-16" onClick={ () => setIsModalOpen(!isModalOpen) } aria-label="contact modal">
