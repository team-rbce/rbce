...
export default function EmailButtonModal() {
  ...
  return (
    <>
      <button className="hidden sm:flex items-center justify-center cursor-pointer fixed right-3 w-14 h-14 rounded-full bg-color-tertiary z-10 sm:right-10 sm:bottom-10 md:bottom-40 md:right-16 lg:right-24" onClick={ () => setIsModalOpen(!isModalOpen) } aria-label="contact modal">
