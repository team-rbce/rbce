  ...
  return (
    <div className="w-full h-full px-3 py-4 sm:px-10 md:px-16 lg:px-24">
      ...
      <div className="flex flex-col gap-6">
        ...
        <DevelopersCard name="Samuel" description="Desenvolvedor Fullstack, foi responsável por desenvolver o site da RBCE e auxiliar no contexto final para a produção." socials={ ['linkedin', 'github'] } />
