...
export default function MainCard({ imagePath }) {
  return (
    <div className="relative text-background-primary-light ">
      <img src={ `/${imagePath}mobile.png` } alt="" className="w-full sm:hidden h-[calc(580px)]" draggable={ false } />
      <img src={ `/${imagePath}.png` } alt="" className="w-full hidden sm:block " draggable={ false } />
